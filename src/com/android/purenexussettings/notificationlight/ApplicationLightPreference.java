...
package com.android.purenexussettings.notificationlight;
...
public class ApplicationLightPreference extends DialogPreference {
    ...
    private void updatePreferenceViews() {
        final int width = (int) mResources.getDimension(R.dimen.light_preference_width);
        final int height = (int) mResources.getDimension(R.dimen.light_preference_height);
    ...
    protected Dialog createDialog() {
        ...
        d.setButton(AlertDialog.BUTTON_POSITIVE, mResources.getString(com.android.internal.R.string.ok),
        ...
        d.setButton(AlertDialog.BUTTON_NEGATIVE, mResources.getString(com.android.internal.R.string.cancel),
                new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
            }
